...
values
  ('a1111111-1111-1111-1111-111111111111', 'CodeCraft Club', 'For coders, by coders. Hackathons, competitive programming, open source & projects.', 'academic', '💻', 'linear-gradient(135deg, #C4956A, #5BB5A2)', 342, '🏆 Inter-college Hackathon registrations open! Deadline: end of month', 'Weekly Code Sprint — Saturday 6 PM', '22222222-2222-2222-2222-222222222222'),
  ('a2222222-2222-2222-2222-222222222222', 'Campus Music Lounge', 'Jam sessions, open mics, and lo-fi vibes. All musicians & listeners welcome!', 'hobby', '🎵', 'linear-gradient(135deg, #A78BCA, #C77D8A)', 189, '🎸 Open Mic Night this Friday 8 PM at the Amphitheater!', 'Open Mic Night — Friday 8 PM', '33333333-3333-3333-3333-333333333333'),
  ('a3333333-3333-3333-3333-333333333333', 'Hostel 4 Crew', 'The unofficial hub for H4 residents. Mess updates, late-night snacks & campus talks.', 'campus-life', '🏠', 'linear-gradient(135deg, #5BB5A2, #5B8EC9)', 156, '🚿 Hot water timings: 6-9 AM & 7-10 PM', 'Floor Table Tennis Tournament — Sunday', '22222222-2222-2222-2222-222222222222'),
  ('a4444444-4444-4444-4444-444444444444', 'Design Studio', 'UI/UX, Graphic Design, Figma tips, portfolio reviews & creative collaboration.', 'academic', '🎨', 'linear-gradient(135deg, #C77D8A, #C4956A)', 98, '📐 Portfolio Review Session — Next Wednesday', 'Portfolio Workshop — Wednesday 5 PM', '33333333-3333-3333-3333-333333333333'),
  ('a5555555-5555-5555-5555-555555555555', 'Gaming Arena', 'Valorant, CS2, Rocket League & FIFA. LAN matches every weekend!', 'hobby', '🎮', 'linear-gradient(135deg, #C75C5C, #C9943A)', 267, '🎮 Monthly LAN Tournament registrations live', 'LAN Party — Saturday 2 PM', '22222222-2222-2222-2222-222222222222'),
  ('a6666666-6666-6666-6666-666666666666', 'Cricket & Sports Club', 'Practice sessions, inter-hostel leagues, and weekend games.', 'sports', '🏏', 'linear-gradient(135deg, #4A9E7F, #5B8EC9)', 210, '🏏 Inter-Hostel Cricket Tournament starts next week!', 'Net Practice — Sunday 6 AM', '22222222-2222-2222-2222-222222222222')
on conflict (id) do nothing;

-- Starter Announcements
insert into public.announcements (id, title, description, category, date, location, organizer, cover_gradient, is_pinned, rsvp_count, interested_count, tags, created_by)
values
  ('b1111111-1111-1111-1111-111111111111', 'Annual Campus TechFest 2026 🚀', '3 days of hackathons, robotics, tech talks from industry leaders, and concerts. Register your team now!', 'fest', now() + interval '20 days', 'Main Auditorium & Tech Complex', 'Student Council', 'linear-gradient(135deg, #C4956A, #5BB5A2)', true, 456, 892, array['TechFest', 'Hackathon', 'Workshops'], '11111111-1111-1111-1111-111111111111'),
  ('b2222222-2222-2222-2222-222222222222', 'Mid-Semester Examinations Timetable 📝', 'The schedule for Mid-Sem exams is now released. Check the student portal for detailed hall allocations.', 'exam', now() + interval '12 days', 'Academic Block Halls A-E', 'Academic Office', 'linear-gradient(135deg, #C75C5C, #C9943A)', true, 0, 234, array['Exams', 'MidSem', 'Schedule'], '11111111-1111-1111-1111-111111111111'),
  ('b3333333-3333-3333-3333-333333333333', 'Campus Open Mic & Acoustic Night 🎤', 'Singing, poetry, stand-up, or instrumental performances. Open for all students!', 'club', now() + interval '5 days', 'Campus Amphitheater', 'Cultural Committee', 'linear-gradient(135deg, #A78BCA, #C77D8A)', false, 134, 345, array['OpenMic', 'Music', 'StandUp'], '33333333-3333-3333-3333-333333333333'),
  ('b4444444-4444-4444-4444-444444444444', '24-Hour Social Impact Hackathon 💡', 'Build software solutions for local community issues. Exciting prizes, mentorship, and free pizza!', 'hackathon', now() + interval '15 days', 'Innovation Lab, Block D', 'CodeCraft Club', 'linear-gradient(135deg, #4A9E7F, #5B8EC9)', false, 89, 234, array['Hackathon', 'Coding', 'SocialImpact'], '22222222-2222-2222-2222-222222222222')
on conflict (id) do nothing;

-- Starter Pulse Posts
insert into public.posts (id, author_id, is_anonymous, anonymous_name, anonymous_emoji, category, content, tags, upvotes, downvotes, reactions, created_at)
values
  ('c1111111-1111-1111-1111-111111111111', null, true, 'Mystic Owl', '🦉', 'confession', 'Saw my crush in the library today and accidentally knocked over an entire shelf of books. They helped me pick them up. Is this a meet-cute or just my life being a disaster movie? 😭📚', array['LibraryCrush', 'CollegeLife', 'Awkward'], 247, 12, '{"🔥": 45, "💀": 89, "❤️": 120, "💡": 3, "😭": 67, "😂": 34}'::jsonb, now() - interval '2 hours'),
  ('c2222222-2222-2222-2222-222222222222', null, true, 'Golden Dragon', '🐉', 'campus-vibe', 'PSA: The vending machine on 3rd floor of Block C gives out TWO packets of chips if you press B4 twice quickly. You are welcome. 🍟', array['LifeHack', 'CampusVibe', 'FoodHack'], 512, 8, '{"🔥": 200, "💀": 15, "❤️": 78, "💡": 150, "😭": 5, "😂": 30}'::jsonb, now() - interval '4 hours'),
  ('c3333333-3333-3333-3333-333333333333', null, true, 'Phantom Wolf', '🐺', 'study', 'Anyone else feel like the Data Structures professor speaks in a language that sounds like English but makes zero sense? Just me? Okay. 🫠', array['DSA', 'Study', 'Help', 'CSE'], 389, 23, '{"🔥": 67, "💀": 178, "❤️": 45, "💡": 12, "😭": 210, "😂": 156}'::jsonb, now() - interval '6 hours'),
  ('c4444444-4444-4444-4444-444444444444', null, true, 'Crystal Falcon', '🦅', 'confession', 'To the person who plays acoustic guitar at Hostel 7 balcony every night at 11 PM — you are literally the soundtrack of my college life. Never stop. 🎸✨', array['Hostel', 'Music', 'Vibes'], 623, 15, '{"🔥": 89, "💀": 12, "❤️": 340, "💡": 8, "😭": 56, "😂": 15}'::jsonb, now() - interval '8 hours')
on conflict (id) do nothing;
